        ...
        <div className="container2">
          <div className="box2">
            ...
            <div className="content">
              ...
              <p>{isEnglish ? "I am a 27 year old girl living in Buenos Aires, Argentina. I am currently studying Web Design and Programming at the Da Vinci School. I have a background in veterinary studies, having worked and studied in that field for six years. However, my passion lies in frontend development with a keen interest in design. In 2022, I started my journey as a developer, focusing on expanding my skills in programming and pursuing a career in the tech industry." : "Soy una chica de 27 años de Buenos Aires, Argentina. Actualmente me encuentro en la carrera de Diseño y programación web en la escuela Da Vinci. Tengo formación en estudios veterinarios y trabajé y estudié en ese campo durante seis años. Sin embargo, mi pasión se encuentra en el desarrollo frontend, con un gran interés en el diseño. En 2022, comencé mi camino como desarrolladora, enfocándome en expandir mis habilidades en programación y persiguiendo una carrera en la industria tecnológica."}
              </p>
            </div>
          </div>
